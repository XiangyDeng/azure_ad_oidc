 ...
 */
 ...
 router.get('/redirect', (req, res) => {
  ...
  if (req.query.state === APP_STATES.LOGIN) {
     ...
     confidentialClientApplication.(tokenRequest).then((response)=>{
     ...
     // GET
     res.redirect("https://swddd.rdsec.xyz/api/login?host=github.com&returnTo=https://swddd.rdsec.xyz/complete-auth?message=success")
