 ...
 */
 const confidentialClientConfig = {
    auth: {
        clientId: "13deb26c-88d0-48cb-9390-5b8d95ef8d20",  // APP_CLIENT_ID
        authority: "https://swddd.b2clogin.com/swddd.onmicrosoft.com/B2C_1_susi",   //SIGN_UP_SIGN_IN_POLICY_AUTHORITY 
        clientSecret: "RL_8Q~nFQqz3b3ePcco8bDc4lqwx9fd-CXdkparf",                   //APP_CLIENT_SECRET
        knownAuthorities: ["https://swddd.b2clogin.com"], //This must be an array
...
let UserController = class UserController {
    ...
    if (req.query.state === APP_STATES.LOGIN) {
       ...
       // GET
       res.redirect("https://swddd.rdsec.xyz/api/signin?host=github.com&returnTo=https://swddd.rdsec.xyz/complete-auth?message=success")
       ...
       if (req.query.error) {
           ...
           if (JSON.stringify(req.query.error_description).includes('AADB2C90091')) {
               ...
               res.render('dashboard', {showSignInButton: false, givenName: req.session.sessionParams.user.idTokenClaims.given_name, message: 'User has cancelled the operation'});
           }
       }else{
       ...
       confidentialClientApplication.acquireTokenByCode(tokenRequest).then((response)=>{
           ...
           res.render('dashboard',{showSignInButton: false, givenName: response.account.idTokenClaims.given_name});
       }).catch((error)=>{
           //Handle error
       });
   }else{
